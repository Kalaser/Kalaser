...
1. [rustfs](https://hellogithub.com/repository/rustfs/rustfs)  
   ...
   - 简介: `rustfs—基于 Rust 的高性能分布式存储系统5该项是用 Rust 构建的高性能分布式对象存储系统，致力于成为 MinIO 的开源替代品。它安装简单、兼容 S3 协议，采用更友好的开源协议，并内置界面清爽的 rustfs·Rust·1 年前8.7k`  
   - 语言: `Rust`  
   - 更新时间: `2026-09-24 03:34:38`  

2. [dashi-ppt-skill](https://hellogithub.com/repository/chuspeeism/dashi-ppt-skill)  
   - 描述: 让 AI Agent 帮你做 PPT  
   - 简介: `dashi-ppt-skill—让 AI Agent 帮你做 PPT2这是一个能够生成可编辑 PPT 的技能包，把文档丢给 Agent 即可生成网页版 PPT，支持在浏览器里直接修改文字、换图片、调布局，以及一键导出为可编辑的 Pchuspeeism·JavaScript·1 个月前3.8k`  
   - 语言: `JavaScript`  
   - 更新时间: `2026-09-24 03:34:38`  

3. [DeskBox](https://hellogithub.com/repository/Tianyu199509/DeskBox)  
   - 描述: 让 Windows 桌面井然有序  
   - 简介: `DeskBox—让 Windows 桌面井然有序10这是一款开源的 Windows 桌面整理工具，为桌面加入具有 Windows 原生质感的文件格子和日常工具。它内置待办、随记、搜索、天气和音乐控制等小组件，支持Tianyu199509·C#·1 个月前6.8k`  
   - 语言: `C#`  
   - 更新时间: `2026-09-24 03:34:38`  

4. [book-to-skill](https://hellogithub.com/repository/virgiliojr94/book-to-skill)  
   - 描述: 把技术书变成智能体技能  
   - 简介: `book-to-skill—把技术书变成智能体技能4这是一款可以将技术书籍和文档转化成 Agent 技能的工具，让 AI 编程助手按需加载并基于原书内容回答。它会自动生成 SKILL.md、按章节拆分的文件、术语virgiliojr94·Python·1 个月前3.9k`  
   - 语言: `Python`  
   - 更新时间: `2026-09-24 03:34:38`  
...
7. [ai-agent-book](https://hellogithub.com/repository/bojieli/ai-agent-book)  
   ...
   - 简介: `ai-agent-book—《深入理解 AI Agent：设计原理与工程实践》4这是一本讲解 AI Agent 的开源中文书籍，围绕「Agent = LLM + 上下文 + 工具」展开，共 10 章。内容从原理讲到生产实践，涵盖上下文工程、bojieli·Python·2 个月前9.1k`  
   - 语言: `Python`  
   - 更新时间: `2026-09-24 03:34:38`  
