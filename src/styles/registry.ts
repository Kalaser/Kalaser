...
const BUILT_IN_STYLES: OutputStyleConfig[] = [
  ...
  {
    name: "Explanatory",
    description: "Kalaser explains its implementation choices and codebase patterns",
    keepCodingInstructions: true,
    source: "built-in",
...
${INSIGHT_FEATURE_PROMPT}`,
  ...
  {
    name: "Learning",
    description: "Kalaser pauses and asks you to write small pieces of code for hands-on practice",
    keepCodingInstructions: true,
    source: "built-in",
