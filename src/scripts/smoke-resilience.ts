...
async function main(): Promise<void> {
  ...
  process.env.KALASER_MAX_RETRIES = "5"; // fast + deterministic
  ...
  delete process.env.KALASER_MAX_RETRIES;

  section("[8] getMaxRetries env override");
  assert(getMaxRetries() === DEFAULT_MAX_RETRIES, `default maxRetries = ${DEFAULT_MAX_RETRIES}`);
  process.env.KALASER_MAX_RETRIES = "2";
  assert(getMaxRetries() === 2, "KALASER_MAX_RETRIES overrides default");
  delete process.env.KALASER_MAX_RETRIES;
